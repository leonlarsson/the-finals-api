...
export const season6SponsorSchema = z
  .object({
    1: z.number(),
...
export const season6SponsorUserSchema = z
  .object({
  ...
  .openapi("Season6SponsorUser", {
    title: "Season 6 Sponsor User",
    description: "A user in the Season 6 Sponsor leaderboard.",
  }) satisfies z.ZodType<z.infer<typeof season6SponsorSchema>[number]>;
