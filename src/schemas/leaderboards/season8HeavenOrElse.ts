...
export const season8HeavenOrElseSchema = z
  .object({
    1: z.number(),
...
export const season8HeavenOrElseUserSchema = z
  .object({
  ...
  .openapi("Season8HeavenOrElseUser", {
    title: "Season 8 Heaven Or Else User",
    description: "A user in the Season 8 Heaven Or Else leaderboard.",
  }) satisfies z.ZodType<z.infer<typeof season8HeavenOrElseSchema>[number]>;
