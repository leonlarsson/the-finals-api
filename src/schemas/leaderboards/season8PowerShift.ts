...
export const season8PowerShiftSchema = z
  .object({
    1: z.number(),
...
export const season8PowerShiftUserSchema = z
  .object({
  ...
  .openapi("Season8PowerShiftUser", {
    title: "Season 8 PowerShift User",
    description: "A user in the Season 8 PowerShift leaderboard.",
  }) satisfies z.ZodType<z.infer<typeof season8PowerShiftSchema>[number]>;
