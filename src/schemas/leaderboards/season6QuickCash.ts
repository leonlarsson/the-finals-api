...
export const season6QuickCashSchema = z
  .object({
    1: z.number(),
...
export const season6QuickCashUserSchema = z
  .object({
  ...
  .openapi("Season6QuickCashUser", {
    title: "Season 6 Quick Qash User",
    description: "A user in the Season 6 Quick Qash leaderboard.",
  }) satisfies z.ZodType<z.infer<typeof season6QuickCashSchema>[number]>;
