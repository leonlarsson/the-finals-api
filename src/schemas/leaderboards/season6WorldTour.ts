...
export const season6WorldTourSchema = z
  .object({
    1: z.number(),
...
export const season6WorldTourUserSchema = z
  .object({
  ...
  .openapi("Season6WorldTourUser", {
    title: "Season 6 World Tour User",
    description: "A user in the Season 6 World Tour leaderboard.",
  }) satisfies z.ZodType<z.infer<typeof season6WorldTourSchema>[number]>;
