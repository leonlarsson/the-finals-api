...
export const season6UserSchema = z
  .object({
  ...
  .openapi("Season6User", {
    title: "Season 6 User",
    description: "A user in the Season 6 leaderboard.",
  }) satisfies z.ZodType<z.infer<typeof season6Schema>[number]>;
