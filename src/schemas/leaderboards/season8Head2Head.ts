...
export const season8Head2HeadSchema = z
  .object({
    1: z.number(),
...
export const season8Head2HeadUserSchema = z
  .object({
  ...
  .openapi("Season8Head2HeadUser", {
    title: "Season 8 Head2Head User",
    description: "A user in the Season 8 Head2Head leaderboard.",
  }) satisfies z.ZodType<z.infer<typeof season8Head2HeadSchema>[number]>;
