...
export const season8BlastOffSchema = z
  .object({
    1: z.number(),
...
export const season8BlastOffUserSchema = z
  .object({
  ...
  .openapi("Season8BlastOffUser", {
    title: "Season 8 Blast Off User",
    description: "A user in the Season 8 Blast Off leaderboard.",
  }) satisfies z.ZodType<z.infer<typeof season8BlastOffSchema>[number]>;
