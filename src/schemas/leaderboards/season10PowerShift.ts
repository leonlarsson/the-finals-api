...
export const season10PowerShiftSchema = z
  .object({
    1: z.number(),
...
export const season10PowerShiftUserSchema = z
  .object({
  ...
  .openapi("Season10PowerShiftUser", {
    title: "Season 10 PowerShift User",
    description: "A user in the Season 10 PowerShift leaderboard.",
  }) satisfies z.ZodType<z.infer<typeof season10PowerShiftSchema>[number]>;
