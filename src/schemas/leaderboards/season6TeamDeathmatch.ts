...
export const season6TeamDeathmatchSchema = z
  .object({
    1: z.number(),
...
export const season6TeamDeathmatchUserSchema = z
  .object({
  ...
  .openapi("Season6TeamDeathmatchUser", {
    title: "Season 6 Team Deathmatch User",
    description: "A user in the Season 6 Team Deathmatch leaderboard.",
  }) satisfies z.ZodType<z.infer<typeof season6TeamDeathmatchSchema>[number]>;
