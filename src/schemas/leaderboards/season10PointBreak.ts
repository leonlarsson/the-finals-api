...
export const season10PointBreakSchema = z
  .object({
    1: z.number(),
...
export const season10PointBreakUserSchema = z
  .object({
  ...
  .openapi("Season10PointBreakUser", {
    title: "Season 10 Point Break User",
    description: "A user in the Season 10 Point Break leaderboard.",
  }) satisfies z.ZodType<z.infer<typeof season10PointBreakSchema>[number]>;
