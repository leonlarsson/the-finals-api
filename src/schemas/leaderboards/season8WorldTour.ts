...
export const season8WorldTourSchema = z
  .object({
    1: z.number(),
...
export const season8WorldTourUserSchema = z
  .object({
  ...
  .openapi("Season8WorldTourUser", {
    title: "Season 8 World Tour User",
    description: "A user in the Season 8 World Tour leaderboard.",
  }) satisfies z.ZodType<z.infer<typeof season8WorldTourSchema>[number]>;
