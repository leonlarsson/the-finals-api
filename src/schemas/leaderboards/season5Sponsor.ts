...
export const season5SponsorSchema = z
  .object({
    1: z.number(),
...
export const season5SponsorUserSchema = z
  .object({
  ...
  .openapi("Season5SponsorUser", {
    title: "Season 5 Sponsor User",
    description: "A user in the Season 5 Sponsor leaderboard.",
  }) satisfies z.ZodType<z.infer<typeof season5SponsorSchema>[number]>;
