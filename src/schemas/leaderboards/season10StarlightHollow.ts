...
export const season10StarlightHollowSchema = z
  .object({
    1: z.number(),
...
export const season10StarlightHollowUserSchema = z
  .object({
  ...
  .openapi("Season10StarlightHollowUser", {
    title: "Season 10 Starlight Hollow User",
    description: "A user in the Season 10 Starlight Hollow leaderboard.",
  }) satisfies z.ZodType<z.infer<typeof season10StarlightHollowSchema>[number]>;
