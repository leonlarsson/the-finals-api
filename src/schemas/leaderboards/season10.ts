...
export const season10UserSchema = z
  .object({
  ...
  .openapi("Season10User", {
    title: "Season 10 User",
    description: "A user in the Season 10 leaderboard.",
  }) satisfies z.ZodType<z.infer<typeof season10Schema>[number]>;
