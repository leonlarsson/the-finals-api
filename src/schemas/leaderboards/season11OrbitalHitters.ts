...
export const season11OrbitalHittersSchema = z
  .object({
    1: z.number(),
...
export const season11OrbitalHittersUserSchema = z
  .object({
  ...
  .openapi("Season11OrbitalHittersUser", {
    title: "Season 11 Orbital Hitters User",
    description: "A user in the Season 11 Orbital Hitters leaderboard.",
  }) satisfies z.ZodType<z.infer<typeof season11OrbitalHittersSchema>[number]>;
