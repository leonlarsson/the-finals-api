...
export const season8GhoulRushSchema = z
  .object({
    1: z.number(),
...
export const season8GhoulRushUserSchema = z
  .object({
  ...
  .openapi("Season8GhoulRushUser", {
    title: "Season 8 Ghoul Rush User",
    description: "A user in the Season 8 Ghoul Rush leaderboard.",
  }) satisfies z.ZodType<z.infer<typeof season8GhoulRushSchema>[number]>;
