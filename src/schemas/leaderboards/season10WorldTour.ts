...
export const season10WorldTourSchema = z
  .object({
    1: z.number(),
...
export const season10WorldTourUserSchema = z
  .object({
  ...
  .openapi("Season10WorldTourUser", {
    title: "Season 10 World Tour User",
    description: "A user in the Season 10 World Tour leaderboard.",
  }) satisfies z.ZodType<z.infer<typeof season10WorldTourSchema>[number]>;
