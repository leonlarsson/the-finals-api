...
export const season7BlastOffSchema = z
  .object({
    1: z.number(),
...
export const season7BlastOffUserSchema = z
  .object({
  ...
  .openapi("Season7BlastOffUser", {
    title: "Season 7 Blast Off User",
    description: "A user in the Season 7 Blast Off leaderboard.",
  }) satisfies z.ZodType<z.infer<typeof season7BlastOffSchema>[number]>;
