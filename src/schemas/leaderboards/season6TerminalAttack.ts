...
export const season6TerminalAttackSchema = z
  .object({
    1: z.number(),
...
export const season6TerminalAttackUserSchema = z
  .object({
  ...
  .openapi("Season6TerminalAttackUser", {
    title: "Season 6 Terminal Attack User",
    description: "A user in the Season 6 Terminal Attack leaderboard.",
  }) satisfies z.ZodType<z.infer<typeof season6TerminalAttackSchema>[number]>;
