...
export const season11PowerShiftSchema = z
  .object({
    1: z.number(),
...
export const season11PowerShiftUserSchema = z
  .object({
  ...
  .openapi("Season11PowerShiftUser", {
    title: "Season 11 PowerShift User",
    description: "A user in the Season 11 PowerShift leaderboard.",
  }) satisfies z.ZodType<z.infer<typeof season11PowerShiftSchema>[number]>;
