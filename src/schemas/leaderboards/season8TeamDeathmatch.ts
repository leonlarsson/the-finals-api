...
export const season8TeamDeathmatchSchema = z
  .object({
    1: z.number(),
...
export const season8TeamDeathmatchUserSchema = z
  .object({
  ...
  .openapi("Season8TeamDeathmatchUser", {
    title: "Season 8 Team Deathmatch User",
    description: "A user in the Season 8 Team Deathmatch leaderboard.",
  }) satisfies z.ZodType<z.infer<typeof season8TeamDeathmatchSchema>[number]>;
