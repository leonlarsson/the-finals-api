...
export const season11QuickCashSchema = z
  .object({
    1: z.number(),
...
export const season11QuickCashUserSchema = z
  .object({
  ...
  .openapi("Season11QuickCashUser", {
    title: "Season 11 Quick Cash User",
    description: "A user in the Season 11 Quick Cash leaderboard.",
  }) satisfies z.ZodType<z.infer<typeof season11QuickCashSchema>[number]>;
