...
export const season11TeamDeathmatchSchema = z
  .object({
    1: z.number(),
...
export const season11TeamDeathmatchUserSchema = z
  .object({
  ...
  .openapi("Season11TeamDeathmatchUser", {
    title: "Season 11 Team Deathmatch User",
    description: "A user in the Season 11 Team Deathmatch leaderboard.",
  }) satisfies z.ZodType<z.infer<typeof season11TeamDeathmatchSchema>[number]>;
