...
export const season8SponsorSchema = z
  .object({
    1: z.number(),
...
export const season8SponsorUserSchema = z
  .object({
  ...
  .openapi("Season8SponsorUser", {
    title: "Season 8 Sponsor User",
    description: "A user in the Season 8 Sponsor leaderboard.",
  }) satisfies z.ZodType<z.infer<typeof season8SponsorSchema>[number]>;
