...
export const season11UserSchema = z
  .object({
  ...
  .openapi("Season11User", {
    title: "Season 11 User",
    description: "A user in the Season 11 leaderboard.",
  }) satisfies z.ZodType<z.infer<typeof season11Schema>[number]>;
