...
export const season10TeamDeathmatchSchema = z
  .object({
    1: z.number(),
...
export const season10TeamDeathmatchUserSchema = z
  .object({
  ...
  .openapi("Season10TeamDeathmatchUser", {
    title: "Season 10 Team Deathmatch User",
    description: "A user in the Season 10 Team Deathmatch leaderboard.",
  }) satisfies z.ZodType<z.infer<typeof season10TeamDeathmatchSchema>[number]>;
