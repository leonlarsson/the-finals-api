...
export const season10QuickCashSchema = z
  .object({
    1: z.number(),
...
export const season10QuickCashUserSchema = z
  .object({
  ...
  .openapi("Season10QuickCashUser", {
    title: "Season 10 Quick Cash User",
    description: "A user in the Season 10 Quick Cash leaderboard.",
  }) satisfies z.ZodType<z.infer<typeof season10QuickCashSchema>[number]>;
