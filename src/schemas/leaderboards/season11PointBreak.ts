...
export const season11PointBreakSchema = z
  .object({
    1: z.number(),
...
export const season11PointBreakUserSchema = z
  .object({
  ...
  .openapi("Season11PointBreakUser", {
    title: "Season 11 Point Break User",
    description: "A user in the Season 11 Point Break leaderboard.",
  }) satisfies z.ZodType<z.infer<typeof season11PointBreakSchema>[number]>;
