...
export const season6HeavyHittersSchema = z
  .object({
    1: z.number(),
...
export const season6HeavyHittersUserSchema = z
  .object({
  ...
  .openapi("Season6HeavyHittersUser", {
    title: "Season 6 Heavy Hitters User",
    description: "A user in the Season 6 Heavy Hitters leaderboard.",
  }) satisfies z.ZodType<z.infer<typeof season6HeavyHittersSchema>[number]>;
