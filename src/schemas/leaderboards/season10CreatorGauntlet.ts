...
export const season10CreatorGauntletSchema = z
  .object({
    1: z.number(),
...
export const season10CreatorGauntletUserSchema = z
  .object({
  ...
  .openapi("Season10CreatorGauntletUser", {
    title: "Season 10 Creator Gauntlet User",
    description: "A user in the Season 10 Creator Gauntlet leaderboard.",
  }) satisfies z.ZodType<z.infer<typeof season10CreatorGauntletSchema>[number]>;
