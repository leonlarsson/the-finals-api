...
export const season10SponsorSchema = z
  .object({
    1: z.number(),
...
export const season10SponsorUserSchema = z
  .object({
  ...
  .openapi("Season10SponsorUser", {
    title: "Season 10 Sponsor User",
    description: "A user in the Season 10 Sponsor leaderboard.",
  }) satisfies z.ZodType<z.infer<typeof season10SponsorSchema>[number]>;
