...
export const season10The24HourGauntletSchema = z
  .object({
    1: z.number(),
...
export const season10The24HourGauntletUserSchema = z
  .object({
  ...
  .openapi("Season10The24HourGauntletUser", {
    title: "Season 10 The 24 Hour Gauntlet User",
    description: "A user in the Season 10 The 24 Hour Gauntlet leaderboard.",
  }) satisfies z.ZodType<z.infer<typeof season10The24HourGauntletSchema>[number]>;
