...
export const season9BankItSchema = z
  .object({
    1: z.number(),
...
export const season9BankItUserSchema = z
  .object({
  ...
  .openapi("Season9BankItUser", {
    title: "Season 9 Bank It User",
    description: "A user in the Season 9 Bank It leaderboard.",
  }) satisfies z.ZodType<z.infer<typeof season9BankItSchema>[number]>;
